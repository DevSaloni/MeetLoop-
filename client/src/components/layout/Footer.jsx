    ...
    <footer className="relative bg-[#09090B] pt-24 pb-12 overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-10 pt-12 border-t border-white/5">
          {/* Social Icons - Customized with Personal Profiles */}
          <div className="flex items-center gap-4">
            {[
              { icon: 'code', label: 'GitHub', link: 'https://github.com/DevSaloni' },
              { icon: 'share', label: 'LinkedIn', link: 'https://www.linkedin.com/in/saloni-pawar-00824b260' }, // Change to your exact LinkedIn profile link
              { icon: 'alternate_email', label: 'Email', link: 'mailto:salonipawar294@gmail.com' }
            ].map((social) => (
              <a
                key={social.label}
                href={social.link}
