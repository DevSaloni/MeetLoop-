    ...
    return (
      <div className="flex items-center justify-center h-[60vh]">
        <div className="flex flex-col items-center gap-4">
          ...
          <span className="text-sm text-on-surface-variant uppercase tracking-widest font-bold">Loading Teams...</span>
        </div>
      </div>
    );
  }
              ...
              {teams.map(team => (
                ...
                >
                  <div className="space-y-4">
                    <div className="flex items-center gap-4">
                      {team.logo ? (
                        <img src={team.logo} alt={team.name} className="w-18 h-18 rounded-xl object-cover shrink-0 border border-white/10" />
                      ) : (
                        <div className="w-14 h-14 bg-gradient-to-br from-primary-container/20 to-primary-container/5 border border-primary-container/20 rounded-xl flex items-center justify-center shrink-0">
                          <span className="material-symbols-outlined text-primary-container text-2xl">group_work</span>
                        </div>
                      )}
